			...
			<div id="content" class="col-sm-12 full">
				<div class="row">
					<div class="login-box">
						...
						<form class="form-horizontal login" action="index.html" method="post" id="login">
							...
							<fieldset class="col-sm-12">
								...
								<div class="row">
									...
									<button id="submit" type="button" class="btn btn-lg btn-primary col-xs-12">Login</button>
