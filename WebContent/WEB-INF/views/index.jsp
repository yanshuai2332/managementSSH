...
<html lang="en">
	<head>
	    ...
	    <title>aaa - Admin Template</title>		
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="index.html"><i class="fa fa-laptop"></i><span class="text"> ${name}</span></a></li>
							<li>
							...
							<li><a href="/mybatiseproject/test/table" /><i class="fa fa-table"></i><span class="text"> Tables</span></a></li>
							<li>
